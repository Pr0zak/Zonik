...
- Artwork contexts: Discover tabs use iTunes API (external tracks, 30s preview); Library/Duplicates/Favorites/Playlists/Upgrades use `/rest/getCoverArt` (local Subsonic, no preview — tracks already owned)
